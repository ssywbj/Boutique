...
#include <stdlib.h>
#include <string.h>
#include "com_example_wbj_jni_Jni.h"
...
JNIEXPORT jint
JNICALL Java_com_example_wbj_jni_Jni_getCInt(JNIEnv *env,
                                      jobject thiz) {
    return add2();
}

JNIEXPORT jstring
JNICALL Java_com_example_wbj_jni_Jni_getCString(JNIEnv *env,
                                         jobject thiz) {
    return env->NewStringUTF("handle by cpp ");
}

JNIEXPORT jint
JNICALL Java_com_example_wbj_jni_Jni_getStatus(JNIEnv *env,
...
JNIEXPORT jint
JNICALL Java_com_example_wbj_jni_Jni_getResponseCode(JNIEnv *env,
